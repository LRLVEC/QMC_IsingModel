...
\end{equation}
and the power-law decay remind us that the critical point of Ising model can be related to some conformal field theory. The critical exponents are listed as Fig.~\ref{fig:Critical_Exponents}.
